...
type IsAdminResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UisAdmin      bool                   `protobuf:"varint,1,opt,name=uis_admin,json=uisAdmin,proto3" json:"uis_admin,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *IsAdminResponse) GetUisAdmin() bool {
	if x != nil {
		return x.UisAdmin
	}
	return false
...
var file_sso_sso_proto_rawDesc = string([]byte{
	...
	0x49, 0x64, 0x22, 0x2e, 0x0a, 0x0f, 0x49, 0x73, 0x41, 0x64, 0x6d, 0x69, 0x6e, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x1b, 0x0a, 0x09, 0x75, 0x69, 0x73, 0x5f, 0x61, 0x64, 0x6d,
	0x69, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x75, 0x69, 0x73, 0x41, 0x64, 0x6d,
	0x69, 0x6e, 0x32, 0xab, 0x01, 0x0a, 0x04, 0x41, 0x79, 0x74, 0x68, 0x12, 0x39, 0x0a, 0x08, 0x52,
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Ayth.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Ayth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Ayth.IsAdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Ayth.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Ayth.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Ayth.IsAdmin:output_type -> auth.IsAdminResponse
